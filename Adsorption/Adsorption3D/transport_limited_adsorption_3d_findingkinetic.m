function heterogenous_binding_analysis()
    ...
    kon_values = logspace(-1, 4, 5);  % Coarse grid for demonstration
    ...
    % ================ VISUALIZATION ================
    plot_results(kon_grid, koff_grid, P_grid, true_params, weights,t(:,1), s_obs, s_fit);
...
function [A,t] = construct_kernel_numerical(param_pairs, nx, ny, nz,...
    ...
    t = zeros(N_t, size(param_pairs, 1));
