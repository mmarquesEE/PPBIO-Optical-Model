...
function [t, c_s, s] = simulate_3d_flow_model(nx, ny, nz, kon_grid,...
    ...
    y0 = [c_s(:); s(:)];
     ...
     % Time parameters
    tspan_assoc = linspace(0, t_assoc, t_assoc/5);
    tspan_diss = linspace(t_assoc, t_total, t_assoc/5);
