function heterogeneous_binding_analysis()
    ...
    ads_x_range = [10,11]; % Central adsorption region (6 cells)
    ads_y_range = [2,3];   % 3 cells in y-direction
    ...
    true_smax = 1.2;                               % Global surface capacity
    ...
    [kon_grid, koff_grid, smax_grid] = generate_hetero_param_grids(...
        ...
        true_kon_grid, true_koff_grid, true_smax);
    ...
    p0_smax = log10(true_smax) + 0.1*randn(1,1);
    ...
    options = optimoptions('fmincon', 'Display', 'iter',...
        'Algorithm', 'interior-point', 'MaxIterations', 40,...
        'UseParallel', true);
