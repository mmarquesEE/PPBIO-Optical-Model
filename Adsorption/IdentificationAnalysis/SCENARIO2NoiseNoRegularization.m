...
% % With noise but no regularization. We expect a poor parameter recovery,
% % demonstrating the ill-posed nature of the problem.
fprintf('--- RUNNING SCENARIO 2: With Noise, No Regularization ---\n');
run_estimation_scenario('2: With Noise, No Regularization', 0.02, 0.0);
...
% run_estimation_scenario('3: With Noise, With Regularization', 0.02, 5e-1);
...
% 
% --- RUNNING SCENARIO 2: With Noise, No Regularization ---
% 
% Experiment 1:
...
% Saved figure to Identifiability_Analysis_2_With_Noise,_No_Regularization.png
% Warning: VideoWriter could not be created. Video will not be saved. Error: Unable to find file. Ensure file exists and path is valid. 
% > In SCENARIO1NoiseNoRegularization>run_estimation_scenario (line 379)
% In SCENARIO1NoiseNoRegularization (line 12) 
% 
...
%      0         13         322.727                           466
%      1         26         23.5452       0.478676            488      
%      2         39         1.34773       0.130437           10.8      
%      3         52        0.495326       0.135309             23      
%      4         65        0.443401      0.0348244          0.122      
%      5         78        0.440217       0.106402          0.165      
%      6         91        0.440033      0.0671528           3.28      
%      7        104        0.439241     0.00868838         0.0897      
%      8        117        0.439228      0.0167882          0.176      
%      9        130        0.439209     0.00419705         0.0273      
%     10        143        0.439209      0.0083941         0.0273      
%     11        156        0.439204     0.00209852         0.0482      
%     12        169        0.439197     0.00419705          0.243      
%     13        182        0.439189     0.00419705          0.217      
%     14        195        0.439182     0.00419705          0.142      
%     15        208        0.439182     0.00754278          0.142      
%     16        221        0.439178     0.00188569         0.0494      
%     17        234        0.439177     0.00377139          0.122      
%     18        247        0.439175     0.00377139          0.127      
%     19        260        0.439173     0.00377139        0.00884      
%     20        273        0.439172     0.00377139         0.0133      
%     21        286        0.439172     0.00377139         0.0326      
%     22        299        0.439172     0.00377139         0.0349      
%     23        312        0.439172    0.000942847        0.00212      
%     24        325        0.439171     0.00188569         0.0169      
%     25        338        0.439171     0.00188569         0.0399      
%     26        351        0.439171     0.00188569         0.0161      
%     27        364        0.439171     0.00188569        0.00168      
%     28        377        0.439171     0.00188569        0.00588      
%     29        390        0.439171    0.000471423       0.000537      
%     30        403        0.439171    0.000942847        0.00257      
%     31        416        0.439171    0.000942847         0.0114      
%     32        429        0.439171    0.000566815       0.000388      
%     33        442        0.439171    0.000942847       0.000388      
%     34        455        0.439171    0.000235712       0.000317      
%     35        468        0.439171    0.000235712       0.000247      
%     36        481        0.439171    5.89279e-05       2.09e-05      
%     37        494        0.439171    0.000117856       9.83e-05      
%     38        507        0.439171     9.6055e-05       9.83e-05      
%     39        520        0.439171    2.40137e-05       9.83e-05      
%     40        533        0.439171    6.00344e-06       9.83e-05      
%     41        546        0.439171    1.50086e-06       9.83e-05      
%     42        559        0.439171    3.75215e-07       9.83e-05      
%     43        572        0.439171    9.38037e-08       9.83e-05      
%     44        585        0.439171    2.34509e-08       9.83e-05      
%     45        598        0.439171    5.86273e-09       9.83e-05      
%     46        611        0.439171    1.46568e-09       9.83e-05      
%     47        624        0.439171    3.66421e-10       9.83e-05      
%     48        637        0.439171    9.16052e-11       9.83e-05      
%     49        650        0.439171    2.29013e-11       9.83e-05      
%     50        663        0.439171    5.72532e-12       9.83e-05      
%     51        676        0.439171    1.43133e-12       9.83e-05      
%     52        689        0.439171    3.57833e-13       9.83e-05      
% 
...
% 
% Optimization Results (Tikhonov Regularized):
% Final Residual Norm (augmented): 6.6270e-01
% Exit Flag: 2
% 
% Parameter Recovery Accuracy (Tikhonov Regularized):
% Mean Relative Error: 8.53%
% Max Relative Error: 13.68%
% Saved figure to Parameter_Recovery_2_With_Noise,_No_Regularization.png
% Saved figure to Signal_Fit_2_With_Noise,_No_Regularization.png
% --- SCENARIO 2 COMPLETE ---