...
video_filename = 'LineAverageModel/Videos/received_data_original.avi';
...
% Example: If your video is 1024 pixels wide, covering 65 to 80 degrees:
angle_range = linspace(65, 80, 1024); % [start_angle, end_angle, num_pixels]
...
n2_calibration_range = linspace(n_bulk, n_bulk + 0.001, 500);
